...
//   serverF(500, "text/plain", msg + "\r\n");
// }

// bool loadFromSdCard(String path) { // /recordings/000xx.csv
...
//     del += x_str;
//     del += ".csv";
//     server.on(del, HTTP_GET, printDirectory); // /recordings/00001 02 03 04 ... 25.csv
//   }
